...
const restaurantList = [
  ...
  },
  {
    ...
    "data": {
      ...
      "cityState": "60",
      "address": "La Pino'z Pizza, shop no. 38 & 39, Ground Floor, West Gate, Near Raiya Circle, 150 Ft. Road, Rajkot",
      "locality": "Rajkot",
      "parentId": 4961,
      "unserviceable": false,
      "veg": true,
  ...
  },
  {
    ...
    "data": {
      ...
      "cityState": "60",
      "address": "Sadar Bazar Main Rd, Sadar Bazar, Sadar, Rajkot, Gujarat 360001",
  ...
  },
  {
    ...
    "data": {
      ...
      "lastMileTravel": 4.5,
      "slugs": {
        "restaurant": "kwality-walls-frozen-dessert-and-ice-cream-shop-bhaktinagar-bhaktinagar",
        "city": "rajkot"
      },
      "cityState": "60",
      "address": "DVISHA TRADE LINKS: 7-ATIKA, DHEBAR ROAD (SOUTH), NR SHIVSHAKTI MOTORS, RAJKOT, GUJARAT-360002",
    ...
    <div className="restaurant-list">
      {
        restaurantList.map(restaurant => {
          return <RestauntCard {...restaurant.data} />;
        }
        )
      }
      {/* <RestauntCard {...restaurantList[0].data} /> */}
      {/* <RestauntCard 
      name={restaurantList[3].data.name} 
      cuisines={restaurantList[3].data.cuisines} /> */}
      {/* <RestauntCard restaurant={restaurantList[2]} /> */}
    </div>
  );
};
